...
public class MenuTopPanel extends JPanel 
{
	...
	JMenuBar menuBar;
	JMenu menu, lngMenu;
	JMenuItem menuItemSave,menuItemStop,menuItemExit,menuItemOpen,menuItemStart,menuItemContinue,menuItemEng, menuItemPl;
	...
	boolean cont=false;
	LeftPanel left;
	MenuTopPanel(MidPanel middle,LeftPanel lef,Options rigth)
	{
		optionsPanel=rigth;
		left=lef;
		mid=middle;
	...
	void changeLanguage()
	{
		...
		//optionsPanel.mass1Change.setText(optionsPanel.options.getString("changeable"));
		//optionsPanel.mass2Change.setText(optionsPanel.options.getString("changeable"));
