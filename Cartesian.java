...
class CartesianPanel extends JPanel {
 ...
 int X_AXIS_FIRST_X_COORD = 50;
 int X_AXIS_SECOND_X_COORD = 600;
 int X_AXIS_Y_COORD = 600;

// y-axis coord constants
 int Y_AXIS_FIRST_Y_COORD = 50;
 int Y_AXIS_SECOND_Y_COORD = 600;
 int Y_AXIS_X_COORD = 50;
...
// distance of coordinate strings from axis
 int AXIS_STRING_DISTANCE = 20;
 MidPanel mid;
 CartesianPanel(MidPanel middle)
 {
	 mid=middle;
	 X_AXIS_SECOND_X_COORD=mid.getWidth();
	 Y_AXIS_SECOND_Y_COORD=mid.getHeight();
 }
